...
const About = () => {
  ...
  return (
    <section id="sobre" className="bg-white py-32 lg:py-40">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                <div key={index} className="flex items-start gap-3">
                  <CheckCircle size={24} style={{ color: '#F6D100' }} className="mt-1 flex-shrink-0" />
                  <span 
                    className="text-lg"
                    style={{ 
                      fontFamily: 'Nunito Sans, sans-serif',
          ...
          <div className="grid grid-cols-2 gap-6">
            {values.map((value, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="bg-gray-50 rounded-3xl p-8 hover:shadow-lg transition-all duration-300 hover:scale-105 border border-gray-100"
                >
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-6" style={{ backgroundColor: '#F6D100' }}>
                    <IconComponent size={28} style={{ color: '#3E2F08' }} />
                  </div>
                  <h4 
        ...
        {/* Process Section */}
        <div className="bg-gray-50 rounded-3xl p-16 border border-gray-100">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div 
                  className="w-16 h-16 text-white rounded-2xl flex items-center justify-center text-xl font-bold mx-auto mb-6"
                  style={{ 
                    backgroundColor: '#3E2F08',
                    fontFamily: 'Nunito Sans, sans-serif'
                  }}
                >
                  {phase.step}
